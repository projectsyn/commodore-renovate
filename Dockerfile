FROM ghcr.io/containerbase/base:11.11.32@sha256:d7ce8dd9960ce217c2735d9abfd3dae678e007f86baaace5ba325b292d925854 AS base
...
RUN install-tool node v20.17.0
